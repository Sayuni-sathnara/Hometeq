...
to make your home and your life super SMART.</p><br><br>";
 
echo "<b>SMART SECURITY</b><br>";

echo "<p class='updateInfo'> Smart-home monitoring products mean you can set up cameras to check on your home, even if you’re in another country. 
You can either watch a live stream through your phone or tablet, or just get alerts when the motion sensor is 
triggered.</p><br><br>";

echo "<b>SMART ENERGY</b><br>";
...
you don’t, 
helping to reduce your energy bills. </p><br><br>";

echo "<b>SMART SPEAKERS</b><br>" ;
echo"<br>";
echo "<p class='updateInfo'>We’ve all got too much to do. 
...
Whatever smart tech you are after, homteq has it on offer!</p><br><br>";
